systemDictionary = {
    ...
    "tooltip_prompt": {
        "en": "You can change standard prompt from 'fhem>' to something else.",
        "de": "Man kann hier ein eigenes Prompt setzen. Default ist 'fhem>'",
        "ru": "Можно задать собственный промпт. По умолчанию 'fhem>'"
    }
};